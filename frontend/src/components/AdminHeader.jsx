...
export default function AdminHeader({ title = "Restaurant Management", pendingOrders = 0 }) {
  ...
  return (
    <>
      <>
        <div className="flex justify-between font-sans items-center lg:mb-0 p-4 md:p-3
    border-b border-[#1C5721]
    bg-[#236B28]
    shadow-sm
  ">
        ...
        transition-colors"
            ...
            {/* <h1 className="text-xl md:text-2xl lg:text-2xl font-bold text-[#EAF5EA]">{title}</h1> */}
          </div>
          ...
          transition-colors"
              ...
              {showProfile && (
                <div className="absolute right-0 mt-3 w-30
            bg-white
