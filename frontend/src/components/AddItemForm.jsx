        ...
        <div className="overflow-y-auto max-h-[450px] custom-scrollbar">
          <table className="min-w-full border-collapse table-fixed text-[12px]">
            <thead className="sticky top-0 bg-[#EAF5EA] uppercase text-[11px] font-semibold text-[#236B28] z-10">
              <tr>
                <th className="w-1/15 border-b border-[#236B28]/20 px-4 py-2 text-left">
                  SN
                </th>
                <th className="w-1/7 border-b border-[#236B28]/20 px-6 py-2 text-left">
                  Date
                </th>
                <th className="w-1/5 border-b border-[#236B28]/20 px-6 py-2 text-left">
                  Name
                </th>
                <th className="w-1/7 border-b border-[#236B28]/20 px-6 py-2 text-left">
                  Price
                </th>
                <th className="w-1/7 border-b border-[#236B28]/20 px-4 py-2 text-left">
                  Category
                </th>
                <th className="w-1/7 border-b border-[#236B28]/20 px-2 py-2 text-left">
                  Unit
                </th>
                <th className="w-1/12 border-b border-[#236B28]/20 px-2 py-2 text-left">
                  Image
                </th>
                <th className="w-1/12 border-b border-[#236B28]/20 px-2 py-2 text-right">
                  Action
                </th>
              </tr>
            </thead>
